package com.caixy.codesandbox.config.properties;
 ...
 * 读取线程池配置
 *
 * @name: com.caixy.codesandbox.config.properties.ThreadPoolExecutionProperties
 * @author: CAIXYPROMISE
 * @since: 2024-02-02 22:25
 **/
@Getter
@Configuration
...
public class ThreadPoolExecutionProperties
{
    ...
    public static class ThreadInstanceProperties
    {
        ...
        // 默认线程工厂
        private String threadFactory = "CustomThreadFactory";
        // 默认拒绝策略
