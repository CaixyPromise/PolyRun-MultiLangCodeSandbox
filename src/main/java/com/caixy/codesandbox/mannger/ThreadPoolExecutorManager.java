...
import com.caixy.codesandbox.config.properties.ThreadPoolExecutionProperties;
...
import static com.caixy.codesandbox.config.properties.ThreadPoolExecutionProperties.createThreadFactory;

/**
 * 线程池管理器
 *
 * @name: com.caixy.ojBackend.manager.ThreadPoolExecutorManager
 * @author: CAIXYPROMISE
